		...
		<div class="row"
			...
			<form action="./AddProductSrv" method="post"
				...
				<div style="font-weight: bold;" class="text-center">
					<h2 style="color: green;">Formulario de Agregar el Producto</h2>
					<%
					if (message != null) {
					%>
					<p style="color: blue;">
				...
				<div class="row">
					<div class="col-md-6 form-group">
						<label for="last_name">Nombre del Producto</label> <input type="text"
							placeholder="Enter Product Name" name="name" class="form-control"
							id="last_name" required>
					</div>
					<div class="col-md-6 form-group">
						<label for="producttype">Typo de Producto</label> <select name="type"
							...
							<option value="other">OTRA CATEGORIAS</option>
						</select>
					</div>
				</div>
				<div class="form-group">
					<label for="last_name">Descripcion del producto</label>
					<textarea name="info" class="form-control" id="last_name" required></textarea>
				</div>
				<div class="row">
					<div class="col-md-6 form-group">
						<label for="last_name">Precio Unitario</label> <input type="number"
				...
				<div>
					<div class="col-md-12 form-group">
						<label for="last_name">Imagen del Producto</label> <input type="file"
