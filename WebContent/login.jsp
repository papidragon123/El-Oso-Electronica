...
<body style="background-color:#faa6a6;">
	...
	<div class="container">
	<br>
	<img src="images/logo.jpg" alt="Logo de Shopping Cr" class="logo-img" width="250px" height="250px" style="display: block; margin: auto; display: block;">
		<div class="row"
			...
			<form action="./LoginSrv" method="post"
				...
				<div style="font-weight: bold;" class="text-center">
					<h2 style="color: green;">Formulario de Entrada</h2>
					<%
					if (message != null) {
					%>
					<p style="color: blue;">
