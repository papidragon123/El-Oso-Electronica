...
<%@ page
	import="com.proyecto.service.impl.*,com.proyecto.service.*,com.proyecto.beans.*,java.util.*,javax.servlet.ServletOutputStream,java.io.*"%>
<!DOCTYPE html>
<html>
<head>
				...
				<div class="row">
					...
					<div class="col-md-6 form-group">
						...
						<label for="producttype">Product Type</label> <select name="type"
							...
							<option value="mueble"
								<%="mueble".equalsIgnoreCase(ptype) ? "selected" : ""%>>MUEBLES</option>
							<option value="electro"
								<%="electro".equalsIgnoreCase(ptype) ? "selected" : ""%>>ELECTRO</option>
							<option value="cocina"
								<%="cocina".equalsIgnoreCase(ptype) ? "selected" : ""%>>COCINA</option>
							<option value="decoracion"
								<%="decoracion".equalsIgnoreCase(ptype) ? "selected" : ""%>>DECORACION</option>
							<option value="pisos"
								<%="pisos".equalsIgnoreCase(ptype) ? "selected" : ""%>>PISOS</option>
							<option value="baños"
								<%="baños".equalsIgnoreCase(ptype) ? "selected" : ""%>>BAÑOS</option>
							<option value="other"
								<%="other".equalsIgnoreCase(ptype) ? "selected" : ""%>>OTRA CATEGORIA</option>
						</select>
					</div>
				</div>
				<div class="form-group">
